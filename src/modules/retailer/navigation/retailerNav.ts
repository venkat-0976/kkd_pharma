...
import type { NavItem } from "@/components/layout/AuthenticatedPortalLayout";
...
export const retailerMobileNav = retailerNav.filter((item) =>
  ["/retailer/profile", "/retailer/documents", "/retailer/licences", "/retailer/alerts"].includes(
    item.to,
  ),
);
