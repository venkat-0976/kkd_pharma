...
export function HospitalAddressPage() {
  const fields = ["Door number / building", "Street", "Area", "City", "District", "Pincode"];
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-border bg-card p-5 shadow-soft sm:p-6">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-semibold">{authService.getSession()?.shopName ?? "Account information"}</h2>
