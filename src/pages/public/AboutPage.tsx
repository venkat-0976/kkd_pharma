...
const milestones = [
  ...
  {
    year: "2019",
    text: "Group health insurance and welfare programmes introduced for member families.",
  },
  {
    year: "2026",
    text: "Secure digital member portal launched for licence and document management.",
  },
];
