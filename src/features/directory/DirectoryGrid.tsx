...
} from "@/components/forms/DirectoryFilters";
...
export function DirectoryGrid({ businesses, areas }: { businesses: PublicBusiness[]; areas: string[] }) {
  ...
  const results = useMemo(() => {
    ...
    return businesses
      .filter((b) => {
        ...
        const matchesCategory = filters.category === "all" || b.categories.includes(filters.category);
