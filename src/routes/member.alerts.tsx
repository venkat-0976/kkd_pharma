...
export const Route = createFileRoute("/member/alerts")({
  head: () => ({
    meta: [
      { title: "Expiry Alerts — Kakinada Union Member Portal" },
      { name: "description", content: "Upcoming licence and document renewals for your pharmacy." },
      ...
      <MemberPageHeader
        ...
        action={
          <Button variant="outline" asChild>
            <Link to="/member/settings">Reminder settings</Link>
          </Button>
        }
      />
