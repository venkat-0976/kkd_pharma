  ...
  head: () => ({
    meta: [
      ...
      { title: "Kakinada Union — Pharmacy Healthcare Association" },
      {
        name: "description",
        content:
          "Kakinada Union is the pharmacy healthcare association for registered retail and wholesale members in Kakinada.",
      },
      { name: "author", content: "Kakinada Union" },
      { property: "og:title", content: "Kakinada Union — Pharmacy Healthcare Association" },
      {
        property: "og:description",
        content: "Association portal for registered retail and wholesale pharmacy members in Kakinada.",
      },
