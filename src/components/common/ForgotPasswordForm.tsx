...
import { forgotPasswordSchema, type ForgotPasswordValues } from "@/utils/validation/publicForms";
    ...
    return (
      <div className="rounded-xl border border-border bg-surface p-6 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          If the details match a registered member, the union office will send reset instructions to
          the registered mobile number. For security, we never confirm whether an account exists.
        </p>
      </div>
    );
  }
