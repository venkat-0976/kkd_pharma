...
const addressRows: { key: keyof AddressValues; label: string }[][] = [
  [
  ...
  return (
    ...
    >
      <SectionCard
        icon={MapPinned}
        title="Shop address"
        description="Add your shop location. Only area and city are shown publicly."
        action={
      ...
      >
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-border/80 bg-surface/50 p-3 sm:p-4">
            <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3">
              <div className="min-w-0">
                <h3 className="font-display text-sm font-bold tracking-tight">Map location</h3>
              </div>
              <Button
                type="button"
                variant="outline"
